...
struct IKCPCB
{
	...
	void *user;
	char *buffer;
	int fastresend;//fastresend
	int fastlimit;
	int nocwnd, stream;//nocwnd取消拥塞控制  stream 是否采用流传输模式
	int logmask;
